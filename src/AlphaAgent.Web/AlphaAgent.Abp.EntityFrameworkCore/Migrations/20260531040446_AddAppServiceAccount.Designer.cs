...
namespace AlphaAgent.Abp.Migrations
{
    ...
    [Migration("20260531040446_AddAppServiceAccount")]
    partial class AddAppServiceAccount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppAgentConfig", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.HasIndex("CreatorId", "AgentName", "IsActive");

                    b.ToTable("AppAgentConfigs", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppConversationParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppConversationParticipants", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppLlmConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppLlmConfigs", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppMoment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMoments", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppRelationships", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppSecurity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSecurities", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppServiceAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppServiceAccounts", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppServiceAccountPost", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ServiceAccountId", "PublishedAt");

                    b.ToTable("AppServiceAccountPosts", (string)null);
                });

            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.AppVersionConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVersionConfigs", (string)null);
                });
