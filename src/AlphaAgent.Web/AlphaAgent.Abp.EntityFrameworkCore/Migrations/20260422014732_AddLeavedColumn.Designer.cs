...
namespace AlphaAgent.Abp.Migrations
{
    ...
    [Migration("20260422014732_AddLeavedColumn")]
    partial class AddLeavedColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.ChatGroup", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.ChatGroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.ChatMessageRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.Connection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.DeviceAuthorization", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.Moment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.Security", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.UserStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlphaAgent.Abp.Domain.Entities.ChatGroupMember", b =>
                {
                    b.HasOne("AlphaAgent.Abp.Domain.Entities.ChatGroup", null)
                        .WithMany("Members")
